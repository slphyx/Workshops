...
{ 
  ...
  #output for W21
  mod[c(0,4,8,12,18,24,30,36,42)+1,]
}
...
plotX<-function(ls){
  plot(ls,type="l",xlim=c(0,45),ylim=c(0,15),xlab="time(hrs)",ylab="log10 parasitaemia",col="blue",lty=1)
  abline(h=8,lty=2)
  obp<-read.csv("paraW21.csv")
  points(obp$time,obp$log.par,col="blue")
}
...
manipulate(
  plotX(ss.model(9.49*(10^10),8,4,5,48,c(6,28,29,38,39,44),"dhaConcW21.txt",24,7,
                 c(7.0664,8.18226,8.18226),c(e50R,e50T,e50S),c(0,0,0),c(95.8046,99.99,99.99),5.77208,192)),                 
